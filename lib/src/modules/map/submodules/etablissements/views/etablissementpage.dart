...
Widget etablissementPage(
    User user,
    BuildContext context,
    SearchModel searchModel,
    MapBloc mapBloc,
    GlobalKey<ExpandableBottomSheetState> expandablesheet) {
  ...
  bool checkIfUserHasReview = false;
  for (var element in searchModel.etablissement!.commentaires!) {
    if (element.userId == user.id) {
      checkIfUserHasReview = true;
    }
  }
  return BlocListener<MapBloc, MapState>(
    listener: (context, state) {
      if (state is ReviewAdded) {
        searchModel.etablissement!.commentaires!.add(state.commentaire!);
      }
    },
            ...
            children: [
              ...
              Visibility(
                ...
                child: Container(
                  ...
                  child: Column(
                    children:
                        buildHoraires(searchModel.etablissement!.horaires!),
                  ),
                ),
              ),
              const SizedBox(
